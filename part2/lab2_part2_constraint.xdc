...
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { sw }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
...
#set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { led[0] }]; #IO_0_35 Sch=led[2]
